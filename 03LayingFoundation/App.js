...
// * React Element
// Its is not intended for browser to understand JSX so we need to convert it to a format that browser can understand specially for React
const jsxHeading2 = // small brackets optional for single line declaration
  (
    <h1 id="heading" className="headings" tabIndex="1">
      Namaste React Foundation by JSX🚀
    </h1>
...
console.log(jsxHeading); // * it is exactly same as a React element but it is written in a different way
...
const HeaderComponent0 = function () {
  return <h1>Namaste React Functional Component 0</h1>;
};
...
const HeaderComponent3 = () => (
  <h1 className="heading3">Namaste React Functional Component 3</h1>
);
...
const HeaderComponent4 = () => (
  ...
  <div id="container">
    ...
    <h2 className="heading3">Namaste React Functional Component 4 🚀 </h2>
  </div>
);
